  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        <a href="#" className="font-mono text-lg font-bold neon-text">
          {">"} SP_
        </a>
        ...
        <button
          ...
          className="md:hidden font-mono text-primary text-xl"
        >
          {mobileOpen ? "[x]" : "[=]"}
        </button>
      </div>
      ...
      {mobileOpen && (
        <motion.div
          ...
          className="md:hidden bg-card/95 backdrop-blur-lg border-b border-border px-6 pb-4"
        >
          {navLinks.map((link) => (
            <a
              key={link.href}
